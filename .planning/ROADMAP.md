...
Plans:
- [x] 02-01-PLAN.md — Module EFS: CheckFlagFileSync + refactoring check_replication_sync + setup_cross_account_replication + dual-map Terraform migration
- [x] 02-02-PLAN.md — Module DB: EnsureSnapshotAvailable + refactoring prepare_snapshot_for_restore + restore_cluster + dual-map Terraform migration
